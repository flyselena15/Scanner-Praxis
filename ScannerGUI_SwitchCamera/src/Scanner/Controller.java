            ...
            if (op.equals("easy")) {
                Task<Void> task = new Task<Void>() {
                    ...
                    public Void call() throws Exception {
                        ...
                        System.out.println("easy sideStitch start");
                        sideStitch();
                        System.out.println("easy sideStitch End");
                        System.out.println("easy scanTail start");
                        scanTail();
                        System.out.println("easy scanTail End");
                        //tailorStitch();
                        System.out.println("easy tesseract start");
                        tesseract();
                        System.out.println("easy tesseract End");
                    /*if(camerasConnected){
                        //deleteFromCameras();
                    }*/
        ...
        easyCreate.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if(!(currentDirectory == null) && !running){
                    ...
                    // 2023/03/31 Wen Start
                    System.out.println("easy import from camera left start");
                    importFromCameras("left");
                    System.out.println("easy import from camera left End");
...
//                    }
                ...
                // 2023/02/17 Wen Start
                // create an alert
                Alert alert2 = new Alert(Alert.AlertType.CONFIRMATION);
                alert2.setTitle("Switch Camera");
                alert2.setHeaderText("Please switch to right camera by pressing physical button.");
                alert2.setResizable(false);
                alert2.setContentText("Click OK when done, and will download pictures from right camera automatically.\nor\nClick Cancel.");


                Optional<ButtonType> result = alert2.showAndWait();
                ButtonType buttonType = result.get();
                if (buttonType == ButtonType.OK) {
                    // 2023/04/14 Wen Start
                    ...
                    // 2023/04/14 Wen End
                    // 2023/03/31 Wen Start
                    System.out.println("easy import from camera right start");
                    importFromCameras("right");
                    System.out.println("easy import from camera right End");
                    if (!camerasConnected) {
                        System.out.println("Cameras not connected");
                        rotateImages();
                    }
    ...
    void scanTail(){
        try{
            ...
            System.out.println("ScanTail - Starting Process Builder...");
            ...
            //Re-direct output of process to console
            System.out.println("ScanTail - Redirect output of process to console...");
            BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream()));
            String line = null;
            while ( (line = reader.readLine()) != null) {
                System.out.println(line);
            ...
            System.out.println("ScanTail - BufferedReader...");
            BufferedReader otherReader = new BufferedReader(new InputStreamReader(process.getErrorStream()));
            line = null;
            while ((line = otherReader.readLine()) != null) {
                System.out.println(line);
    ...
    void importFromCameras(String dest){
        if(leftCamDirectory == null){
            return;
        }
//        makeDirectories();
        if(dest == "left"){
            downloadFromCamera("" + leftCamDirectory, dest);
        }
        else if(dest == "right"){
            downloadFromCamera("" + rightCamDirectory, dest);
        }
//        downloadFromCamera("" + leftCamDirectory, dest);
    ...
    void hardTab() {
        hardImport.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                //makeDirectories();
                runOperation("import");
                // 2023/02/24 Wen Start
                // create an alert
                Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                alert.setTitle("Switch Camera");
                alert.setHeaderText("Please switch to camera 2 by pressing physical button.");
                alert.setResizable(false);
                alert.setContentText("Click OK when done, and will import from camera 2 automatically.\nor\nClick Cancel.");
        ...
        hardDelete.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (alert.getResult() == ButtonType.YES) {
                    ...
                    Alert alert2 = new Alert(Alert.AlertType.CONFIRMATION);
                    alert2.setTitle("Switch Camera");
                    alert2.setHeaderText("Please switch to camera 2 by pressing physical button.");
                    alert2.setResizable(false);
                    alert2.setContentText("Click OK when done, and will delete from camera 2 automatically.\nor\nClick Cancel.");
                    Optional<ButtonType> result = alert2.showAndWait();
                    ButtonType buttonType = result.get();
                    if (buttonType == ButtonType.OK) {
                        runOperation("delete");
